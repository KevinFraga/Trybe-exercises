...
function imc() {
  ...
  let catType;
  if (imc < 18.5) catType = 0;
  else if (imc < 25) catType = 1;
  else if (imc < 30) catType = 2;
  else if (imc < 35) catType = 3;
  else if (imc < 40) catType = 4;
  else catType = 5;
  console.log(`Seu IMC é de: ${imc}, sua categoria é: ${categorias[catType]}`);
}
